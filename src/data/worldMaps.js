...
export const worldMaps = {
  ferdona: withMapEntity({
    ...
    labels: [
      ...
      { text: "华斯特兰州", x: 1368, y: 428 },
      { text: "西门瑟姆州", x: 1761, y: 575 },
      { text: "图特布梅州", x: 1172, y: 718 },
      { text: "忒卡西诺州", x: 1272, y: 844 },
    ...
    cities: withMapCities([
      { text: "小屋", x: 703, y: 858, markerX: 703, markerY: 883 },
      { text: "忒卡西诺城", x: 1292, y: 884, markerX: 1292, markerY: 906 },
      { text: "芝士牛排城", x: 1554, y: 833, markerX: 1472, markerY: 833 },
      { text: "汽车城", x: 1427, y: 972, markerX: 1370, markerY: 972 },
      { text: "酒城", x: 1964, y: 1157, markerX: 1920, markerY: 1157 },
      { entityKey: "taran", x: 2011, y: 198, markerX: 2011, markerY: 226 },
      { entityKey: "rattown", x: 1512, y: 427, markerX: 1512, markerY: 454 },
      { text: "蓝图", x: 1968, y: 284, markerX: 1929, markerY: 284 },
      { entityKey: "shalom", x: 2337, y: 515, markerX: 2337, markerY: 543 },
    ]),
  }),
  hespera: withMapEntity({
    ...
    labels: [
      ...
      { text: "危雷齐", x: 949, y: 604 },
      { text: "庞提瓦尔", x: 882, y: 985 },
      { text: "奥塞拉", x: 312, y: 1277 },
      { text: "特律庭", x: 2131, y: 1315 },
    ],
    cities: withMapCities([
