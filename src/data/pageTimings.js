...
export const pageTimings = {
  ...
  homeMasterIndex: {
    ...
    clusterEnterBaseDelayMs: 100,
    clusterEnterStepMs: 150,
    railLabelDelayMs: 1120,
    railTopLineDelayMs: 1240,
    railDiamondDelayMs: 1500,
    railBottomLineDelayMs: 1580,
    railEmblemDelayMs: 1740,
    railTitleDelayMs: 1880,
    railMottoDelayMs: 1980,
    railDotsDelayMs: 2080,
    railHintDelayMs: 2240,
    nodeEnterBaseDelayMs: 2280,
    nodeEnterStepMs: 150,
    connectorEnterBaseDelayMs: 2400,
    connectorEnterStepMs: 160,
  },
};
